...
export default defineComponent({
  ...
  setup() {
    ...
    const nav = computed(() => [
      ...
      { href: "/about", text: t("nav.about"), target: "_self" },
      { href: "/portfolio", text: t("nav.portfolio"), target: "_self" },
      { href: "/career", text: t("nav.career"), target: "_self" },
      { href: "/contact", text: t("nav.contact"), target: "_self" },
    ]);
