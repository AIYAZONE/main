  ...
  <section class="certification-display">
    <div class="middle-box">
      <div class="section-header">
        <h2 class="certifications-title">{{ $t('certifications.title', 'Professional Certifications') }}</h2>
        <p class="section-subtitle">{{ $t('certifications.subtitle', 'Validated expertise and continuous learning') }}</p>
      </div>
            ...
            <div class="cert-info">
              ...
              <div class="cert-details">
                ...
                <div class="cert-credential">
                  <span class="label">{{ $t('certifications.credential', 'Credential ID') }}:</span>
      ...
      <div v-if="certifications.length === 0" class="no-certifications">
        ...
        <h3 class="empty-title">{{ $t('certifications.empty.title', 'No Certifications') }}</h3>
        <p class="empty-description">{{ $t('certifications.empty.description', 'Certifications will appear here when available.') }}</p>
      </div>
    </div>
  </section>
</template>
