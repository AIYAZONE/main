    ...
    <div class="portfolio-controls">
      ...
      <div class="filter-section">
        <div class="filter-group">
          ...
          <select v-model="selectedCategory" @change="handleCategoryFilter" class="filter-select">
...
const totalFilteredProjects = computed(() => {
  return filteredProjectGroups.value.reduce((total, group) => total + group.projects.length, 0);
});
...
const hasActiveFilters = computed(() => {
  return searchTerm.value || selectedCategory.value || selectedStatus.value || selectedTech.value;
});

const currentFilters = computed((): FilterCriteria => ({
