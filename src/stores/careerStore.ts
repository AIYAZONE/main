	...
	const loadCareerData = async () => {
		...
		try {
			...
			const mockRoadmapData: RoadmapData = {
				...
				title: '前端架构师职业发展路线图',
				description:
					'24个月分阶段学习+实战路线，目标成为深圳市场40-60K档位的前端架构师',
				phases: [
					{
						id: '1',
						name: '阶段一：工程化基石与性能深耕',
					...
					},
					{
						...
						keyMilestones: [
							...
							},
							{
								...
								title: '微前端 POC',
								description:
									'基于 Module Federation 搭建微前端验证项目。',
						...
						learningGoals: [
							{
								...
								title: '现代前端架构',
								description:
									'掌握 Monorepo 与 Micro-frontends 架构设计',
								resources: [],
								practicalProjects: [],
								successCriteria: [
									'成功迁移 Monorepo',
						...
						keyMilestones: [
							{
								...
								title: 'BFF 层设计落地',
								description:
									'使用 Node.js (NestJS) 搭建 BFF 层，聚合微服务接口。',
