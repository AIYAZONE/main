...
class SocialServiceImpl implements SocialService {
      ...
      return [
        {
          id: 'blog',
          name: 'AIYA Blog',
          description: '技术博客和个人思考，记录前端开发和项目管理的心得体会',
        ...
        },
        {
          id: 'linkedin',
          name: 'LinkedIn',
          description: '职业动态和行业见解，连接技术管理领域的专业人士',
      ...
      const mockFeed: SocialPost[] = [
        {
          ...
          title: '前端架构设计的思考与实践',
          content: '在大型前端项目中，架构设计的重要性不言而喻。本文分享了我在多个项目中的架构设计思考，包括模块化、组件化、工程化等方面的实践经验。通过合理的架构设计，可以显著提升开发效率和代码质量。',
        ...
        },
        {
          ...
          content: '新版本增加了手势识别功能，支持更多交互方式。优化了渲染性能，新增了多种粒子效果。欢迎大家体验和反馈！这个项目展示了WebGL在交互式3D应用中的强大能力。',
        ...
        },
        {
          ...
          content: '从组件设计到打包优化，全面提升Vue应用性能。本文详细介绍了Vue 3的性能优化策略，包括响应式优化、组件懒加载、代码分割等技术。通过实际案例展示优化效果，并提供性能测试数据对比。',
        ...
        },
        {
          ...
          content: '参加了深圳前端技术大会，分享了关于"前端工程化实践"的主题演讲。会上与众多技术专家交流了前端发展趋势，收获颇丰。感谢大家的热情参与和宝贵建议！期待下次再聚。',
          url: 'https://linkedin.com/posts/aiyazone-tech-talk-shenzhen',
          publishedAt: new Date(Date.now() - 10 * 24 * 60 * 60 * 1000),
          tags: ['技术分享', '前端工程化', '深圳', '演讲', '交流'],
          likes: 78,
          comments: 15,
          views: 1200
        },
        {
          ...
          content: '前端架构师需要具备哪些技能？如何从高级前端工程师成长为架构师？本文从技术深度、业务理解、团队协作等多个维度分析了前端架构师的成长路径，并提供了具体的学习建议和实践方向。',
        ...
        },
        {
          ...
          content: '将PMP项目管理方法论应用到前端团队管理中，可以显著提升项目交付质量和团队协作效率。本文结合实际案例，分享了敏捷开发、风险管理、沟通协调等方面的实践经验。',
  ...
  async syncExternalContent(): Promise<void> {
    try {
      ...
      console.warn('Failed to sync external content (non-critical):', error);
  ...
  async fetchBlogPosts(): Promise<any[]> {
    try {
      ...
      console.warn('Failed to fetch blog posts, returning empty array:', error);
      return [];
    }
  }
